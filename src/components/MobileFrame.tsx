...
const IllustrationChat = () => (
  ...
  >
    ...
    />
    <path
      d="M20 11 L20 19 M20 19 C20 20.1 19.1 21 18 21 C16.9 21 16 20.1 16 19 C16 17.9 16.9 17 18 17 C18.7 17 19.4 17.4 19.8 18"
      stroke="#FF5A5F"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M20 11 L26 9 L26 14 L20 16"
      stroke="#FF5A5F"
      strokeWidth="1.3"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    <path
      d="M34 3 L34 5 M31.5 5.5 L33 7 M36.5 5.5 L35 7"
      stroke="#FF5A5F"
      strokeWidth="1.2"
      strokeLinecap="round"
      opacity="0.7"
...
const IllustrationPix = () => (
  ...
  >
    <path
      d="M22 4 L36 10 L36 24 C36 31 29 38 22 40 C15 38 8 31 8 24 L8 10 Z"
      fill="#E8F5E9"
      stroke="#4CAF50"
      strokeWidth="1.5"
      strokeLinejoin="round"
...
const IllustrationDownload = () => (
  ...
  >
    ...
    />
    <path
      d="M22 13 L22 20 M22 20 C22 21.1 21.1 22 20 22 C18.9 22 18 21.1 18 20 C18 18.9 18.9 18 20 18 C20.7 18 21.4 18.4 21.8 19"
      stroke="#FF5A5F"
      strokeWidth="1.4"
      strokeLinecap="round"
    />
    <path
      d="M22 13 L26 12 L26 16 L22 17"
      stroke="#FF5A5F"
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M22 31 L22 36 M19 33.5 L22 36 L25 33.5"
      stroke="#FF5A5F"
      strokeWidth="1.8"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      <div className="flex flex-col lg:flex-row w-full min-h-screen bg-white overflow-visible">
        ...
        <div className="flex-1 min-w-0 lg:w-1/2 lg:shrink-0 flex flex-col bg-white relative min-h-screen lg:min-h-0 lg:h-full">
          ...
          >
            ...
            <header
              id="app-brand-header"
              className="relative z-40 bg-white/95 backdrop-blur-md border-b border-gray-100 px-6 py-4 flex items-center justify-between lg:justify-end shrink-0"
            >
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  <div>
                    ...
                    <span className="text-[#FF5A5F] font-bold text-sm ml-0.5">
                      Música
                    </span>
                  </div>
