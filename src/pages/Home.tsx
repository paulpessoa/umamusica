  ...
  return (
    <MobileFrame>
      ...
      >
        ...
        <div className="shrink-0 px-6 pt-3 pb-5 space-y-4 lg:space-y-6 border-t border-gray-100 bg-white flex flex-col items-center">
          <button
            onClick={handleStart}
          ...
          {user && (
            <button
              ...
              className="w-full max-w-xs bg-white hover:bg-gray-50 text-gray-700 font-bold py-3.5 px-4 rounded-2xl border border-gray-200 flex items-center justify-center gap-2 text-sm tracking-wide transition-all cursor-pointer"
            >
